...
SOURCES = ./src/main.cpp ./src/Config.cpp ./src/GuiWindow.cpp ./src/Processing.cpp ./src/helper/JackHelper.cpp ./src/helper/DspHelper.cpp ./src/helper/Transport.cpp ./src/Types.cpp
HEADER = ./src/Config.hpp ./src/GuiWindow.hpp ./src/Processing.hpp ./src/helper/JackHelper.hpp ./src/helper/DspHelper.hpp ./src/helper/Transport.hpp ./src/Types.hpp
