...
INCLUDES = -I./src/gui -I./src/gui/concurrentqueue -I./src/gui/json/include -I./src/helper -I./src/q/q_lib/include -I./src/q/infra/include `pkg-config --cflags gtk+-3.0 webkit2gtk-4.0 jack`
...
LINKS = `pkg-config --libs gtk+-3.0 webkit2gtk-4.0 jack` -lsndfile -lsamplerate #-lrubberband
...
types:
	node deps/TypeGenerator src/types/*.yaml
