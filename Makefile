...
SOURCES = ./src/main_old.cpp ./src/Config.cpp ./src/ConfigFile.cpp ./src/gui/GuiWindow.cpp ./src/Processing.cpp ./src/helper/JackHelper.cpp ./src/helper/DspHelper.cpp ./src/helper/Transport.cpp ./src/helper/WaveHelper.cpp ./src/SampleExplorer.cpp ./src/Types.cpp
