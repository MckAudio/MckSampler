...
int main(int narg, char **args)
{
	...
	loop_index = 0;
	num_notes = (narg - 3)/3;
	note_frqs = (unsigned char*) malloc(num_notes*sizeof(unsigned char));
	note_starts = (jack_nframes_t *) malloc(num_notes*sizeof(jack_nframes_t));
	note_lengths = (jack_nframes_t *) malloc(num_notes*sizeof(jack_nframes_t));
