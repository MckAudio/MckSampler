...
var app = (function () {
    ...
    const file = "src/mck/controls/Pad.svelte";
    ...
    function create_each_block_1(ctx) {
    	...
    	function func(...args) {
    		return /*func*/ ctx[3](/*pad*/ ctx[6], ...args);
    	}
    ...
    function create_each_block(ctx) {
    	...
    	function func_1(...args) {
    		return /*func_1*/ ctx[4](/*pad*/ ctx[6], ...args);
    	}
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 48, 4, 1120);
    			attr_dev(div1, "class", "empty svelte-1t6hdpc");
    			add_location(div1, file$1, 52, 4, 1288);
    			attr_dev(div2, "class", "main svelte-1t6hdpc");
    			add_location(div2, file$1, 47, 0, 1097);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$2 = "src/mck/controls/TogglePad.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 31, 4, 685);
    			attr_dev(div1, "class", "main svelte-1a1q3uk");
    			add_location(div1, file$3, 30, 0, 662);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$4, 74, 2, 1428);
    			add_location(div1, file$4, 80, 3, 1578);
    			attr_dev(div2, "class", "content svelte-t78j8k");
    			add_render_callback(() => /*div2_elementresize_handler*/ ctx[6].call(div2));
    			add_location(div2, file$4, 75, 2, 1455);
    			attr_dev(div3, "class", "master");
    			add_location(div3, file$4, 84, 2, 1640);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$4, 72, 0, 1402);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
