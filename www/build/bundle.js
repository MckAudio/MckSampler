...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "highlight svelte-wr8ut4");
    			add_location(div, file, 39, 8, 791);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(main, "height", /*boxWidth*/ ctx[0] + "px");
    			attr_dev(main, "class", "svelte-wr8ut4");
    			add_render_callback(() => /*main_elementresize_handler*/ ctx[4].call(main));
    		...
    		m: function mount(target, anchor) {
    			...
    			main_resize_listener = add_resize_listener(main, /*main_elementresize_handler*/ ctx[4].bind(main));
    			current = true;

    			if (!mounted) {
    				dispose = listen_dev(main, "click", /*ButtonClick*/ ctx[2], false, false, false);
    				mounted = true;
    			}
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("Handler" in $$props) $$invalidate(3, Handler = $$props.Handler);
    		if ("boxWidth" in $$props) $$invalidate(0, boxWidth = $$props.boxWidth);
    	...
    	return [boxWidth, active, ButtonClick, Handler, main_elementresize_handler];
    }

    class Pad extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { Handler: 3 });
